  ...
  (function () {
    var h,
      ...
      return +new Date();
        ...
        r = function r(a, b) {
      function c() {}c.prototype = b.prototype;a.vd = b.prototype;a.prototype = new c();a.prototype.constructor = a;a.Qf = function (a, c, f) {
    ...
    ob = pb && y ? ib() || ("CSS1Compat" == pb.compatMode ? parseInt(nb, 10) : 5) : void 0;var qb = null,
      ...
      this.Da = 64;this.dc = l.Uint8Array ? new Uint8Array(this.Da) : Array(this.Da);this.Ec = this.hb = 0;this.h = [];this.hf = a;this.Ud = b;this.Jf = l.Int32Array ? new Int32Array(64) : Array(64);void 0 !== wb || (wb = l.Int32Array ? new Int32Array(xb) : xb);this.reset();
    },
        wb;r(yb, vb);for (var zb = [], Ab = 0; 63 > Ab; Ab++) {
      zb[Ab] = 0;
    }var Bb = Ma(128, zb);yb.prototype.reset = function () {
      this.Ec = this.hb = 0;this.h = l.Int32Array ? new Int32Array(this.Ud) : Na(this.Ud);
    };
    var Cb = function Cb(a) {
      var b = a.dc;v(b.length == a.Da);for (var c = a.Jf, d = 0, e = 0; e < b.length;) {
        ...
        var yh = ((d >>> 2 | d << 30) ^ (d >>> 13 | d << 19) ^ (d >>> 22 | d << 10)) + (d & e ^ d & k ^ e & k) | 0,
            g = C & db ^ ~C & Pb,
    ...
    yb.prototype.update = function (a, b) {
      void 0 === b && (b = a.length);var c = 0,
        ...
        this.dc[d++] = a.charCodeAt(c++), d == this.Da && (Cb(this), d = 0);
      } else if (fa(a)) for (; c < b;) {
        var e = a[c++];if (!("number" == typeof e && 0 <= e && 255 >= e && e == (e | 0))) throw Error("message must be a byte array");this.dc[d++] = e;d == this.Da && (Cb(this), d = 0);
      } else throw Error("message must be string or array");this.hb = d;this.Ec += b;
    };
    yb.prototype.digest = function () {
      var a = [],
          b = 8 * this.Ec;56 > this.hb ? this.update(Bb, 56 - this.hb) : this.update(Bb, this.Da - (this.hb - 56));for (var c = 63; 56 <= c; c--) {
        this.dc[c] = b & 255, b /= 256;
      }Cb(this);for (c = b = 0; c < this.hf; c++) {
    ...
    var xb = [1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298];var Eb = function Eb() {
      ...
      this.Fa = this.Fa;this.sc = this.sc;
    };Fb.prototype.Fa = !1;Fb.prototype.isDisposed = function () {
      return this.Fa;
    };Fb.prototype.cb = function () {
      if (this.sc) for (; this.sc.length;) {
        this.sc.shift()();
      }
    };var Gb = !y || 9 <= Number(ob),
        Hb = y && !z("9");!hb || z("528");gb && z("1.9b") || y && z("8") || cb && z("9.5") || hb && z("528");gb && !z("8") || y && z("9");var Ib = function Ib(a, b) {
      this.type = a;this.currentTarget = this.target = b;this.defaultPrevented = this.nb = !1;this.ce = !0;
    };Ib.prototype.preventDefault = function () {
      this.defaultPrevented = !0;this.ce = !1;
    ...
    Jb.prototype.init = function (a, b) {
      ...
      Jb.vd.preventDefault.call(this);var a = this.eb;if (a.preventDefault) a.preventDefault();else if (a.returnValue = !1, Hb) try {
        if (a.ctrlKey || 112 <= a.keyCode && 123 >= a.keyCode) a.keyCode = -1;
      } catch (b) {}
    };Jb.prototype.Ne = function () {
      return this.eb;
    };var Kb = "closure_listenable_" + (1E6 * Math.random() | 0),
        Lb = 0;var Mb = function Mb(a, b, c, d, e) {
      this.listener = a;this.wc = null;this.src = b;this.type = c;this.capture = !!d;this.jc = e;this.key = ++Lb;this.rb = this.cc = !1;
    },
        Nb = function Nb(a) {
      a.rb = !0;a.listener = null;a.wc = null;a.src = null;a.jc = null;
    };var Ob = function Ob(a) {
      this.src = a;this.G = {};this.Zb = 0;
    };Ob.prototype.add = function (a, b, c, d, e) {
      var f = a.toString();a = this.G[f];a || (a = this.G[f] = [], this.Zb++);var g = Qb(a, b, d, e);-1 < g ? (b = a[g], c || (b.cc = !1)) : (b = new Mb(b, this.src, f, !!d, e), b.cc = c, a.push(b));return b;
    };Ob.prototype.remove = function (a, b, c, d) {
      a = a.toString();if (!(a in this.G)) return !1;var e = this.G[a];b = Qb(e, b, c, d);return -1 < b ? (Nb(e[b]), Ja(e, b), 0 == e.length && (delete this.G[a], this.Zb--), !0) : !1;
    };
    var Rb = function Rb(a, b) {
      var c = b.type;c in a.G && Ka(a.G[c], b) && (Nb(b), 0 == a.G[c].length && (delete a.G[c], a.Zb--));
    };Ob.prototype.Sc = function (a, b, c, d) {
      a = this.G[a.toString()];var e = -1;a && (e = Qb(a, b, c, d));return -1 < e ? a[e] : null;
    };var Qb = function Qb(a, b, c, d) {
      for (var e = 0; e < a.length; ++e) {
        var f = a[e];if (!f.rb && f.listener == b && f.capture == !!c && f.jc == d) return e;
      }return -1;
      ...
      if (!b) throw Error("Invalid event type");var g = !!e,
          k = Yb(a);k || (a[Sb] = k = new Ob(a));c = k.add(b, c, d, e, f);if (!c.wc) {
        d = Zb();c.wc = d;d.src = a;d.listener = c;if (a.addEventListener) a.addEventListener(b.toString(), d, g);else if (a.attachEvent) a.attachEvent($b(b.toString()), d);else throw Error("addEventListener and attachEvent are unavailable.");
        Ub++;
      }
    },
        Zb = function Zb() {
      ...
      if (ea(b)) for (var f = 0; f < b.length; f++) {
        dc(a, b[f], c, d, e);
      } else c = Wb(c), a && a[Kb] ? a.fa.remove(String(b), c, d, e) : a && (a = Yb(a)) && (b = a.Sc(b, c, !!d, e)) && ec(b);
    },
        ec = function ec(a) {
      if (!ga(a) && a && !a.rb) {
        var b = a.src;if (b && b[Kb]) Rb(b.fa, a);else {
          var c = a.type,
              d = a.wc;b.removeEventListener ? b.removeEventListener(c, d, a.capture) : b.detachEvent && b.detachEvent($b(c), d);Ub--;(c = Yb(b)) ? (Rb(c, a), 0 == c.Zb && (c.src = null, b[Sb] = null)) : Nb(a);
        }
      }
    },
        $b = function $b(a) {
      ...
      var e = !0;if (a = Yb(a)) if (b = a.G[b.toString()]) for (b = b.concat(), a = 0; a < b.length; a++) {
        ...
        fc = function fc(a, b) {
      var c = a.listener,
          d = a.jc || a.src;a.cc && ec(a);return c.call(d, b);
    },
        ac = function ac(a, b) {
      ...
      this.Bc = "";this.ue = jc;
    };kc.prototype.Db = !0;kc.prototype.Ab = function () {
      return this.Bc;
    };kc.prototype.toString = function () {
      return "Const{" + this.Bc + "}";
    };var lc = function lc(a) {
      if (a instanceof kc && a.constructor === kc && a.ue === jc) return a.Bc;ya("expected object of type Const, got '" + a + "'");return "type_error:Const";
    },
        jc = {},
        mc = function mc(a) {
      var b = new kc();b.Bc = a;return b;
    };mc("");var oc = function oc() {
      this.vc = "";this.ve = nc;
    };oc.prototype.Db = !0;oc.prototype.Ab = function () {
      return this.vc;
    };oc.prototype.toString = function () {
      return "TrustedResourceUrl{" + this.vc + "}";
    };var nc = {};var qc = function qc() {
      this.pa = "";this.te = pc;
    };qc.prototype.Db = !0;qc.prototype.Ab = function () {
      return this.pa;
    };qc.prototype.toString = function () {
      return "SafeUrl{" + this.pa + "}";
    };
    var rc = function rc(a) {
      if (a instanceof qc && a.constructor === qc && a.te === pc) return a.pa;ya("expected object of type SafeUrl, got '" + a + "' of type " + ca(a));return "type_error:SafeUrl";
    },
        sc = /^(?:(?:https?|mailto|ftp):|[^&:/?#]*(?:[/?#]|$))/i,
        uc = function uc(a) {
      if (a instanceof qc) return a;a = a.Db ? a.Ab() : String(a);sc.test(a) || (a = "about:invalid#zClosurez");return tc(a);
    },
        pc = {},
        tc = function tc(a) {
        ...
        if ("object" == typeof b) {
          if (ea(b)) {
            var d = b;b = d.length;c.push("[");for (var e = "", f = 0; f < b; f++) {
              c.push(e), e = d[f], vc(a, a.xc ? a.xc.call(d, String(f), e) : e, c), e = ",";
            }c.push("]");return;
          }if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();else {
            c.push("{");f = "";for (d in b) {
              Object.prototype.hasOwnProperty.call(b, d) && (e = b[d], "function" != typeof e && (c.push(f), yc(d, c), c.push(":"), vc(a, a.xc ? a.xc.call(b, d, e) : e, c), f = ","));
            }c.push("}");return;
          }
    ...
    };var Bc = function Bc() {};Bc.prototype.Bd = null;var Cc = function Cc(a) {
      return a.Bd || (a.Bd = a.Yc());
    };var Dc,
        Ec = function Ec() {};r(Ec, Bc);Ec.prototype.ec = function () {
      var a = Fc(this);return a ? new ActiveXObject(a) : new XMLHttpRequest();
    };Ec.prototype.Yc = function () {
    ...
    };Dc = new Ec();var Gc = function Gc() {};r(Gc, Bc);Gc.prototype.ec = function () {
    ...
    };Gc.prototype.Yc = function () {
      return {};
    };
    var Hc = function Hc() {
      this.ta = new XDomainRequest();this.readyState = 0;this.onreadystatechange = null;this.responseText = "";this.status = -1;this.statusText = this.responseXML = null;this.ta.onload = _q(this.Pe, this);this.ta.onerror = _q(this.Qd, this);this.ta.onprogress = _q(this.Qe, this);this.ta.ontimeout = _q(this.Re, this);
    };h = Hc.prototype;h.open = function (a, b, c) {
      if (null != c && !c) throw Error("Only async requests are supported.");this.ta.open(a, b);
    };
    h.send = function (a) {
      if (a) {
        if ("string" == typeof a) this.ta.send(a);else throw Error("Only string data is supported");
      } else this.ta.send();
    };h.abort = function () {
      this.ta.abort();
    };h.setRequestHeader = function () {};h.Pe = function () {
      this.status = 200;this.responseText = this.ta.responseText;Ic(this, 4);
    };h.Qd = function () {
      ...
      this.bf = c;this.De = a;this.tf = b;this.rc = 0;this.kc = null;
    };Jc.prototype.get = function () {
      var a;0 < this.rc ? (this.rc--, a = this.kc, this.kc = a.next, a.next = null) : a = this.De();return a;
    };Jc.prototype.put = function (a) {
      this.tf(a);this.rc < this.bf && (this.rc++, a.next = this.kc, this.kc = a);
      ...
      var a = l.MessageChannel;"undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !x("Presto") && (a = function a() {
        ...
        var b = new a(),
          ...
          if (void 0 !== c.next) {
            c = c.next;var a = c.Ed;c.Ed = null;a();
          }
        };return function (a) {
          d.next = { Ed: a };d = d.next;b.port2.postMessage(0);
        };
      ...
      var c = Pc.get();c.set(a, b);this.Hc ? this.Hc.next = c : (v(!this.Ya), this.Ya = c);this.Hc = c;
    };Nc.prototype.remove = function () {
      var a = null;this.Ya && (a = this.Ya, this.Ya = this.Ya.next, this.Ya || (this.Hc = null), a.next = null);return a;
    };var Oc = function Oc() {
    ...
    Oc.prototype.reset = function () {
      ...
      this.pa = "";this.se = Wc;
    };Xc.prototype.Db = !0;Xc.prototype.Ab = function () {
      return this.pa;
    };Xc.prototype.toString = function () {
      return "SafeHtml{" + this.pa + "}";
    };var Yc = function Yc(a) {
      if (a instanceof Xc && a.constructor === Xc && a.se === Wc) return a.pa;ya("expected object of type SafeHtml, got '" + a + "' of type " + ca(a));return "type_error:SafeHtml";
    },
        Wc = {};Xc.prototype.Ye = function (a) {
      this.pa = a;return this;
    };var $c = function $c(a, b) {
      Sa(b, function (b, d) {
        b && b.Db && (b = b.Ab());"style" == d ? a.style.cssText = b : "class" == d ? a.className = b : "for" == d ? a.htmlFor = b : Zc.hasOwnProperty(d) ? a.setAttribute(Zc[d], b) : 0 == d.lastIndexOf("aria-", 0) || 0 == d.lastIndexOf("data-", 0) ? a.setAttribute(d, b) : a[d] = b;
      });
    },
      ...
      this.N = 0;this.qa = void 0;this.ab = this.na = this.s = null;this.ic = this.Qc = !1;if (a != ba) try {
        ...
        ed = function ed() {
      this.next = this.context = this.jb = this.Na = this.child = null;this.wb = !1;
    };ed.prototype.reset = function () {
      this.context = this.jb = this.Na = this.child = null;this.wb = !1;
    };
    var fd = new Jc(function () {
      ...
      var d = fd.get();d.Na = a;d.jb = b;d.context = c;return d;
    },
        B = function B(a) {
      ...
      return new A(function (b) {
        var c = a.length,
          ...
          c--;d[a] = _e ? { Le: !0, value: f } : { Le: !1, reason: f };0 == c && b(d);
        }, f = 0, g; f < a.length; f++) {
      ...
      b = gd(b, b, void 0);b.wb = !0;ld(a, b);return a;
    ...
    var nd = function nd(a, b) {
      if (0 == a.N) if (a.s) {
        var c = a.s;if (c.na) {
          for (var d = 0, e = null, f = null, g = c.na; g && (g.wb || (d++, g.child == a && (e = g), !(e && 1 < d))); g = g.next) {
            e || (f = g);
          }e && (0 == c.N && 1 == d ? nd(c, b) : (f ? (d = f, v(c.na), v(null != d), d.next == c.ab && (c.ab = d), d.next = d.next.next) : od(c), pd(c, e, 3, b)));
        }a.s = null;
      } else cd(a, 3, b);
    },
        ld = function ld(a, b) {
      a.na || 2 != a.N && 3 != a.N || qd(a);v(null != b.Na);a.ab ? a.ab.next = b : a.na = b;a.ab = b;
    },
    ...
    var cd = function cd(a, b, c) {
      0 == a.N && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.N = 1, hd(c, a.Gf, a.Hf, a) || (a.qa = c, a.N = b, a.s = null, qd(a), 3 != b || c instanceof dd || rd(a, c)));
    },
      ...
      var f = !1,
        ...
        qd = function qd(a) {
      a.Qc || (a.Qc = !0, Uc(a.He, a));
    },
        od = function od(a) {
      var b = null;a.na && (b = a.na, a.na = b.next, b.next = null);a.na || (a.ab = null);null != b && v(null != b.Na);return b;
    };A.prototype.He = function () {
      for (var a; a = od(this);) {
        pd(this, a, this.N, this.qa);
      }this.Qc = !1;
    };
    var pd = function pd(a, b, c, d) {
      if (3 == c && b.jb && !b.wb) for (; a && a.ic; a = a.s) {
        a.ic = !1;
      }if (b.child) b.child.s = null, td(b, c, d);else try {
        b.wb ? b.Na.call(b.context) : td(b, c, d);
      } catch (e) {
        ud.call(null, e);
      }fd.put(b);
    },
        td = function td(a, b, c) {
      2 == b ? a.Na.call(a.context, c) : a.jb && a.jb.call(a.context, c);
    },
        rd = function rd(a, b) {
      a.ic = !0;Uc(function () {
        a.ic && ud.call(null, b);
    ...
    var vd = function vd(a, b) {
      this.yc = [];this.Yd = a;this.Hd = b || null;this.Bb = this.fb = !1;this.qa = void 0;this.sd = this.Ad = this.Lc = !1;this.Fc = 0;this.s = null;this.Mc = 0;
    };vd.prototype.cancel = function (a) {
      if (this.fb) this.qa instanceof vd && this.qa.cancel();else {
        if (this.s) {
          var b = this.s;delete this.s;a ? b.cancel(a) : (b.Mc--, 0 >= b.Mc && b.cancel());
        }this.Yd ? this.Yd.call(this.Hd, this) : this.sd = !0;this.fb || wd(this, new xd());
      }
    };vd.prototype.Fd = function (a, b) {
      this.Lc = !1;yd(this, a, b);
    };
    var yd = function yd(a, b, c) {
      a.fb = !0;a.qa = c;a.Bb = !b;zd(a);
    },
        Bd = function Bd(a) {
      if (a.fb) {
        if (!a.sd) throw new Ad();a.sd = !1;
      }
    ...
    var wd = function wd(a, b) {
      ...
      v(!a.Ad, "Blocking Deferreds can not be re-used");a.yc.push([b, c, d]);a.fb && zd(a);
    ...
    var Hd = function Hd(a) {
      ...
      if (a.Fc && a.fb && Hd(a)) {
        var b = a.Fc,
            c = Id[b];c && (l.clearTimeout(c.Cb), delete Id[b]);a.Fc = 0;
      }a.s && (a.s.Mc--, delete a.s);for (var b = a.qa, d = c = !1; a.yc.length && !a.Lc;) {
        var e = a.yc.shift(),
            f = e[0],
            g = e[1],
            e = e[2];if (f = a.Bb ? g : f) try {
          var k = f.call(e || a.Hd, b);void 0 !== k && (a.Bb = a.Bb && (k == b || k instanceof Error), a.qa = b = k);if (bd(b) || "function" === typeof l.Promise && b instanceof l.Promise) d = !0, a.Lc = !0;
        } catch (n) {
          b = n, a.Bb = !0, Hd(a) || (c = !0);
        }
      }a.qa = b;d && (k = _q(a.Fd, a, !0), d = _q(a.Fd, a, !1), b instanceof vd ? (Fd(b, k, d), b.Ad = !0) : b.then(k, d));c && (b = new Jd(b), Id[b.Cb] = b, a.Fc = b.Cb);
    },
        Ad = function Ad() {
      t.call(this);
      ...
      this.Cb = l.setTimeout(_q(this.Ff, this), 0);this.P = a;
    };
    Jd.prototype.Ff = function () {
      v(Id[this.Cb], "Cannot throw an error that is not scheduled.");delete Id[this.Cb];throw this.P;
    };var Id = {};var Dd = function Dd(a) {
      var b = new oc();b.vc = a;return Kd(b);
    },
        Kd = function Kd(a) {
      var b = {},
          c = b.document || document,
          d;a instanceof oc && a.constructor === oc && a.ve === nc ? d = a.vc : (ya("expected object of type TrustedResourceUrl, got '" + a + "' of type " + ca(a)), d = "type_error:TrustedResourceUrl");var e = document.createElement("SCRIPT");a = { de: e, Yb: void 0 };var f = new vd(Ld, a),
          g = null,
          k = null != b.timeout ? b.timeout : 5E3;0 < k && (g = window.setTimeout(function () {
        Md(e, !0);wd(f, new Nd(1, "Timeout reached for loading script " + d));
      }, k), a.Yb = g);e.onload = e.onreadystatechange = function () {
        e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Md(e, b.Rf || !1, g), f.callback(null));
      };e.onerror = function () {
      ...
      var b;return (b = (a || document).getElementsByTagName("HEAD")) && 0 != b.length ? b[0] : a.documentElement;
        ...
        Ld = function Ld() {
      if (this && this.de) {
        var a = this.de;a && "SCRIPT" == a.tagName && Md(a, !0, this.Yb);
      }
    },
      ...
      throw Pd;
    };Qd.prototype.we = function () {
      return this;
    };var Rd = function Rd(a, b) {
      this.ga = {};this.w = [];this.vb = this.o = 0;var c = arguments.length;if (1 < c) {
    ...
    };Rd.prototype.xb = function (a) {
      return Td(this.ga, a);
    };
    Rd.prototype.remove = function (a) {
      return Td(this.ga, a) ? (delete this.ga[a], this.o--, this.vb++, this.w.length > 2 * this.o && Sd(this), !0) : !1;
    ...
    h.set = function (a, b) {
      Td(this.ga, a) || (this.o++, this.w.push(a), this.vb++);this.ga[a] = b;
    };h.addAll = function (a) {
    ...
    h.we = function (a) {
      Sd(this);var b = 0,
        ...
        if (c != d.vb) throw Error("The map has changed since the iterator was created");if (b >= d.w.length) throw Pd;var e = d.w[b++];return a ? e : d.ga[e];
      };return e;
    ...
    };Xd.prototype.Kd = null;var Yd = 0;Xd.prototype.reset = function (a, b, c, d, e) {
      "number" == typeof e || Yd++;d || la();this.Hb = a;this.ef = b;delete this.Kd;
    };Xd.prototype.ge = function (a) {
      this.Hb = a;
    };var Zd = function Zd(a) {
      this.ff = a;this.Rd = this.Nc = this.Hb = this.s = null;
    },
        $d = function $d(a, b) {
      ...
      return this.s;
    };Zd.prototype.ge = function (a) {
      this.Hb = a;
    };var de = function de(a) {
      if (a.Hb) return a.Hb;if (a.s) return de(a.s);ya("Root logger has no level set.");return null;
    };
    Zd.prototype.log = function (a, b, c) {
      if (a.value >= de(this).value) for (p(b) && (b = b()), a = new Xd(a, String(b), this.ff), c && (a.Kd = c), c = "log:" + a.ef, l.console && (l.console.timeStamp ? l.console.timeStamp(c) : l.console.markTimeline && l.console.markTimeline(c)), l.msWriteProfilerMark && l.msWriteProfilerMark(c), c = this; c;) {
        var d = c,
            e = a;if (d.Rd) for (var f = 0; b = d.Rd[f]; f++) {
          b(e);
        }c = c.getParent();
      }
    };
    var ee = {},
        fe = null,
        ge = function ge(a) {
      fe || (fe = new Zd(""), ee[""] = fe, fe.ge(be));var b;if (!(b = ee[a])) {
        b = new Zd(a);var c = a.lastIndexOf("."),
            d = a.substr(c + 1),
            c = ge(a.substr(0, c));c.Nc || (c.Nc = {});c.Nc[d] = b;b.s = c;ee[a] = b;
      }return b;
    };var he = function he() {
      Fb.call(this);this.fa = new Ob(this);this.xe = this;this.fd = null;
    ...
    h.dispatchEvent = function (a) {
      ie(this);var b,
          c = this.fd;if (c) {
        b = [];for (var d = 1; c; c = c.fd) {
          b.push(c), v(1E3 > ++d, "infinite loop");
        }
      }c = this.xe;d = a.type || a;if (m(a)) a = new Ib(a, c);else if (a instanceof Ib) a.target = a.target || c;else {
    ...
    var cc = function cc(a, b, c, d, e) {
      ...
      b = a.fa.G[String(b)];if (!b) return !0;b = b.concat();for (var e = !0, f = 0; f < b.length; ++f) {
        var g = b[f];if (g && !g.rb && g.capture == c) {
          var k = g.listener,
              n = g.jc || g.src;g.cc && Rb(a.fa, g);e = !1 !== k.call(n, d) && e;
        }
      }return e && 0 != d.ce;
    };he.prototype.Sc = function (a, b, c, d) {
      ...
      he.call(this);this.headers = new Rd();this.Jc = a || null;this.ua = !1;this.Ic = this.b = null;this.Gb = this.Xd = this.pc = "";this.Ja = this.Wc = this.nc = this.Pc = !1;this.sb = 0;this.Dc = null;this.be = "";this.Gc = this.pf = this.re = !1;
    };r(F, he);var oe = F.prototype,
        pe = ge("goog.net.XhrIo");oe.U = pe;var qe = /^https?$/i,
        re = ["POST", "PUT"];
    F.prototype.send = function (a, b, c, d) {
      if (this.b) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.pc + "; newUri=" + a);b = b ? b.toUpperCase() : "GET";this.pc = a;this.Gb = "";this.Xd = b;this.Pc = !1;this.ua = !0;this.b = this.Jc ? this.Jc.ec() : Dc.ec();this.Ic = this.Jc ? Cc(this.Jc) : Cc(Dc);this.b.onreadystatechange = _q(this.$d, this);this.pf && "onprogress" in this.b && (this.b.onprogress = _q(function (a) {
        this.Zd(a, !0);
      }, this), this.b.upload && (this.b.upload.onprogress = _q(this.Zd, this)));try {
        E(this.U, se(this, "Opening Xhr")), this.Wc = !0, this.b.open(b, String(a), !0), this.Wc = !1;
      } catch (f) {
      ...
      }, this);this.be && (this.b.responseType = this.be);"withCredentials" in this.b && this.b.withCredentials !== this.re && (this.b.withCredentials = this.re);try {
        te(this), 0 < this.sb && (this.Gc = ue(this.b), E(this.U, se(this, "Will abort after " + this.sb + "ms if incomplete, xhr2 " + this.Gc)), this.Gc ? (this.b.timeout = this.sb, this.b.ontimeout = _q(this.Yb, this)) : this.Dc = ke(this.Yb, this.sb, this)), E(this.U, se(this, "Sending request")), this.nc = !0, this.b.send(a), this.nc = !1;
      } catch (f) {
    ...
    F.prototype.Yb = function () {
      "undefined" != typeof aa && this.b && (this.Gb = "Timed out after " + this.sb + "ms, aborting", E(this.U, se(this, this.Gb)), this.dispatchEvent("timeout"), this.abort(8));
    };F.prototype.P = function (a, b) {
      this.ua = !1;this.b && (this.Ja = !0, this.b.abort(), this.Ja = !1);this.Gb = b;ve(this);we(this);
    };var ve = function ve(a) {
      a.Pc || (a.Pc = !0, a.dispatchEvent("complete"), a.dispatchEvent("error"));
    };
    F.prototype.abort = function () {
      this.b && this.ua && (E(this.U, se(this, "Aborting")), this.ua = !1, this.Ja = !0, this.b.abort(), this.Ja = !1, this.dispatchEvent("complete"), this.dispatchEvent("abort"), we(this));
    };F.prototype.cb = function () {
      this.b && (this.ua && (this.ua = !1, this.Ja = !0, this.b.abort(), this.Ja = !1), we(this, !0));F.vd.cb.call(this);
    };F.prototype.$d = function () {
      this.isDisposed() || (this.Wc || this.nc || this.Ja ? xe(this) : this.kf());
    };F.prototype.kf = function () {
      xe(this);
    };
    var xe = function xe(a) {
      if (a.ua && "undefined" != typeof aa) if (a.Ic[1] && 4 == ye(a) && 2 == ze(a)) E(a.U, se(a, "Local request error detected and ignored"));else if (a.nc && 4 == ye(a)) ke(a.$d, 0, a);else if (a.dispatchEvent("readystatechange"), 4 == ye(a)) {
        E(a.U, se(a, "Request complete"));a.ua = !1;try {
          var b = ze(a),
              c;a: switch (b) {case 200:case 201:case 202:case 204:case 206:case 304:case 1223:
              c = !0;break a;default:
              c = !1;}var d;if (!(d = c)) {
            var e;if (e = 0 === b) {
              var f = String(a.pc).match(me)[1] || null;if (!f && l.self && l.self.location) var g = l.self.location.protocol,
    ...
    var Ae = function Ae(a, b) {
      ...
      if (a.b) {
        te(a);var c = a.b,
            d = a.Ic[0] ? ba : null;a.b = null;a.Ic = null;b || a.dispatchEvent("ready");try {
        ...
        te = function te(a) {
      a.b && a.Gc && (a.b.ontimeout = null);ga(a.Dc) && (l.clearTimeout(a.Dc), a.Dc = null);
    },
        ye = function ye(a) {
    ...
    G.prototype.resolve = function (a) {
      var b = this.clone(),
          c = !!a.ha;c ? Ce(b, a.ha) : c = !!a.Wa;if (c) {
        var d = a.Wa;H(b);b.Wa = d;
      } else c = !!a.ea;c ? De(b, a.ea) : c = null != a.lb;d = a.wa;if (c) Ee(b, a.lb);else if (c = !!a.wa) {
        if ("/" != d.charAt(0)) if (this.ea && !this.wa) d = "/" + d;else {
      ...
      }c ? Fe(b, d) : c = "" !== a.W.toString();c ? Ge(b, a.W.clone()) : c = !!a.Ia;c && (a = a.Ia, H(b), b.Ia = a);return b;
    ...
    var Ce = function Ce(a, b, c) {
      ...
      H(a);b instanceof I ? (a.W = b, a.W.rd(a.S)) : (c || (b = Ie(b, Ne)), a.W = new I(b, 0, a.S));
    },
        J = function J(a, b, c) {
      H(a);a.W.set(b, c);
    },
    ...
    G.prototype.removeParameter = function (a) {
      ...
      if (a.af) throw Error("Tried to modify a read-only Uri");
    };G.prototype.rd = function (a) {
      this.S = a;this.W && this.W.rd(a);return this;
    };
    ...
    h.add = function (a, b) {
      ...
      Se(this);a = this.R(a);return this.l.xb(a) ? (this.O = null, this.o = za(this.o) - this.l.get(a).length, this.l.remove(a)) : !1;
    };h.xb = function (a) {
      Se(this);a = this.R(a);return this.l.xb(a);
    };h.oa = function () {
    ...
    h.Z = function (a) {
      Se(this);var b = [];if (m(a)) this.xb(a) && (b = Ma(b, this.l.get(this.R(a))));else {
        a = this.l.Z();for (var c = 0; c < a.length; c++) {
          b = Ma(b, a[c]);
        }
      }return b;
    };h.set = function (a, b) {
      Se(this);this.O = null;a = this.R(a);this.xb(a) && (this.o = za(this.o) - this.l.get(a).length);this.l.set(a, [b]);this.o = za(this.o) + 1;return this;
    };h.get = function (a, b) {
    ...
    I.prototype.rd = function (a) {
      ...
      this.Cf = a;this.df = b;a = c || K();d = d || L();this.$e = af(a) || "ReactNative" === d;
    };xf.prototype.get = function () {
      return this.$e ? this.df : this.Cf;
    };
    var yf = function yf() {
    ...
    var N = function N(a, b, c) {
      ...
      Cf ? Object.defineProperty(a, "provider", { configurable: !0, enumerable: !0, get: function get() {
          Bf("firebase.auth.AuthCredential.provider is deprecated. Please use the providerId field instead.");return "password";
        } }) : a.provider = "password";
    },
        Ff = function Ff(a, b) {
      if (b) for (var c in b) {
      ...
      var b = a;if ("object" == typeof a && null != a) {
        ...
        Mf = { Mf: { Lb: 500, Kb: 600, providerId: "facebook.com", od: Lf }, Nf: { Lb: 500, Kb: 620, providerId: "github.com", od: Lf }, Of: { Lb: 515, Kb: 680, providerId: "google.com", od: Lf }, Pf: { Lb: 485, Kb: 705, providerId: "twitter.com", od: Kf } },
        Nf = function Nf(a) {
      for (var b in Mf) {
    ...
    var Pf = function Pf(a) {
      ...
      this.da = a;this.J = b || null;this.tb = c || null;this.qd = d || null;this.P = e || null;if (this.tb || this.P) {
        if (this.tb && this.P) throw new O("invalid-auth-event");if (this.tb && !this.qd) throw new O("invalid-auth-event");
      ...
      return { type: this.da, eventId: this.J, urlResponse: this.tb, sessionId: this.qd, error: this.P && this.P.C() };
    };
    var Qf = function Qf(a) {
      ...
      this.cf = a.sub;la();this.fc = a.email || null;
      ...
      return a.then(function (a) {
        if (a.idToken) {
          ...
          }if (!c || b != c.cf) throw new O("user-mismatch");return a;
        ...
        Uf = function Uf(a, b) {
      if (b.idToken || b.accessToken) b.idToken && N(this, "idToken", b.idToken), b.accessToken && N(this, "accessToken", b.accessToken);else if (b.oauthToken && b.oauthTokenSecret) N(this, "accessToken", b.oauthToken), N(this, "secret", b.oauthTokenSecret);else throw new O("internal-error", "failed to construct a credential");N(this, "provider", a);N(this, "providerId", a);
    };Uf.prototype.zb = function (a) {
      return Vf(a, Wf(this));
    };Uf.prototype.ad = function (a, b) {
    ...
    var Zf = function Zf(a, b) {
      this.sf = b || [];Ff(this, { providerId: a, isOAuthProvider: !0 });this.Gd = {};
    };Zf.prototype.setCustomParameters = function (a) {
      this.Gd = Xa(a);return this;
    };var Q = function Q(a) {
      Zf.call(this, a, Lf);this.pd = [];
    };r(Q, Zf);Q.prototype.addScope = function (a) {
      Ia(this.pd, a) || this.pd.push(a);return this;
    ...
    var gg = function gg(a, b) {
      var c = a;ha(c) || (c = { oauthToken: a, oauthTokenSecret: b });if (!c.oauthToken || !c.oauthTokenSecret) throw new O("argument-error", "credential failed: expected 2 arguments (the OAuth access token and secret).");return new Uf("twitter.com", c);
        ...
        hg = function hg(a, b) {
      this.fc = a;this.gd = b;Ef(this);N(this, "providerId", "password");
    };hg.prototype.zb = function (a) {
      return R(a, ig, { email: this.fc, password: this.gd });
    };hg.prototype.ad = function (a, b) {
      return R(a, jg, { idToken: b, email: this.fc, password: this.gd });
    };
    hg.prototype.cd = function (a, b) {
      return Tf(this.zb(a), b);
    };hg.prototype.C = function () {
      return { email: this.fc, password: this.gd };
    };var kg = function kg() {
      Ff(this, { providerId: "password", isOAuthProvider: !1 });
    };Ff(kg, { PROVIDER_ID: "password" });var lg = function lg(a) {
      if (!(a.zd && a.yd || a.Xb && a.xa)) throw new O("internal-error");this.I = a;N(this, "providerId", "identifier");
    };lg.prototype.zb = function (a) {
      return a.qe(mg(this));
    };lg.prototype.ad = function (a, b) {
    ...
    lg.prototype.cd = function (a, b) {
      ...
      var a = { providerId: "identifier" };this.I.zd && (a.verificationId = this.I.zd);this.I.yd && (a.verificationCode = this.I.yd);this.I.Xb && (a.temporaryProof = this.I.Xb);this.I.xa && (a.identifierNumber = this.I.xa);return a;
    };
    var mg = function mg(a) {
      return a.I.Xb && a.I.xa ? { temporaryProof: a.I.Xb, identifierNumber: a.I.xa } : { sessionInfo: a.I.zd, code: a.I.yd };
    },
        pg = function pg(a) {
      try {
        this.Ae = a || firebase.auth();
      } catch (b) {
    ...
    pg.prototype.qe = function (a, b) {
      var c = this.Ae.g;return B(b.getAssertion()).then(function (d) {
        if (!m(d)) throw new O("argument-error", "An implementation of firebase.auth.ApplicationVerifier.prototype.getAssertion() must return a firebase.Promise that resolves with a string.");switch (b.type) {case "recaptcha":
    ...
    var rg = function rg(a) {
      if (a.temporaryProof && a.identifierNumber) return new lg({ Xb: a.temporaryProof, xa: a.identifierNumber });var b = a && a.providerId;if (!b || "password" === b) return null;var c = a && a.oauthAccessToken,
      ...
      O.call(this, a, c);a = b || {};a.email && N(this, "email", a.email);a.xa && N(this, "identifierNumber", a.xa);a.credential && N(this, "credential", a.credential);
    ...
    var S = function S(a, b, c) {
      ...
      wf() ? ($e() ? a = _q(a.Bf, a) : (Ag || (Ag = new A(function (a, b) {
        Bg(a, b);
      })), a = _q(a.Af, a)), a(b, c, d, e, f, g)) : c && c(null);
    };
    S.prototype.Bf = function (a, b, c, d, e, f) {
      var g = "Node" == L(),
          k = lf() ? g ? new F(this.Kf) : new F() : new F(this.Ce),
        ...
        n && clearTimeout(n);this.Fa || (this.Fa = !0, this.cb());
      });cc(k, "timeout", function () {
        n && clearTimeout(n);this.Fa || (this.Fa = !0, this.cb());b && b(null);
      });k.send(a, c, d, e);
    };
    ...
    S.prototype.Af = function (a, b, c, d, e) {
    ...
    var Eg = function Eg(a, b) {
      return new A(function (c, d) {
        "refresh_token" == b.grant_type && b.refresh_token || "authorization_code" == b.grant_type && b.code ? Cg(a, a.yf + "?key=" + encodeURIComponent(a.j), function (a) {
          a ? a.error ? d(Dg(a)) : a.access_token && a.refresh_token ? c(a) : d(new O("internal-error")) : d(new O("network-request-failed"));
        }, "POST", Ue(b).toString(), a.ee, a.zf.get()) : d(new O("internal-error"));
      });
    },
        Fg = function Fg(a, b, c, d, e, f) {
      var g = Pe(a.Je + b);J(g, "key", a.j);f && J(g, "cb", la().toString());var k = "GET" == c;if (k) for (var n in d) {
        ...
        }, c, k ? void 0 : xc(sf(d)), a.Nd, a.Ke.get());
      });
    },
        Gg = function Gg(a) {
    ...
    var dh = { endpoint: "setAccountInfo", A: ah, Va: "email" },
        ...
        fh = { endpoint: "deleteAccount", Ta: ["idToken"] },
        Ug = { endpoint: "setAccountInfo", Ta: ["idToken", "deleteProvider"], A: function A(a) {
        if (!ea(a.deleteProvider)) throw new O("internal-error");
      } },
        gh = { endpoint: "getAccountInfo" },
        Sg = { endpoint: "getOobConfirmationCode", Ta: ["idToken", "requestType"], A: function A(a) {
        if ("VERIFY_EMAIL" != a.requestType) throw new O("internal-error");
      }, Va: "email" },
        Rg = { endpoint: "getOobConfirmationCode", Ta: ["requestType"], A: function A(a) {
        if ("PASSWORD_RESET" != a.requestType) throw new O("internal-error");Gg(a);
      }, Va: "email" },
        Kg = { Be: !0, endpoint: "getProjectConfig", Ue: "GET" },
        bh = { endpoint: "resetPassword", A: ah, Va: "email" },
        qg = { endpoint: "sendVerificationCode", Ta: ["identifierNumber", "recaptchaToken"], Va: "sessionInfo" },
        Pg = { endpoint: "setAccountInfo",
      Ta: ["idToken"], A: Hg, ra: !0 },
        jg = { endpoint: "setAccountInfo", Ta: ["idToken"], A: function A(a) {
        Hg(a);if (!a.password) throw new O("weak-password");
      }, Y: Mg, ra: !0 },
        Og = { endpoint: "signupNewUser", Y: Mg, ra: !0 },
        Yg = { endpoint: "verifyAssertion", A: Wg, Y: Xg, ra: !0 },
        ...
        og = { Ee: { USER_NOT_FOUND: "user-not-found" },
      endpoint: "verifyidentifierNumber", A: Ng, Y: Mg },
        R = function R(a, b, c) {
      if (!If(c, b.Ta)) return D(new O("internal-error"));var d = b.Ue || "POST",
          e;return B(c).then(b.A).then(function () {
        b.ra && (c.returnSecureToken = !0);return Fg(a, b.endpoint, d, c, b.Ee, b.Be || !1);
      }).then(function (a) {
        return e = a;
      }).then(b.Y).then(function () {
        if (!b.Va) return e;if (!(b.Va in e)) throw new O("internal-error");return e[b.Va];
      });
    },
        Dg = function Dg(a, b) {
      ...
      return this.V;
    };ih.prototype.he = function (a) {
      this.V.style = a;return this;
    };var jh = function jh(a) {
      this.V = a || {};
    };jh.prototype.value = function () {
      return this.V;
    };jh.prototype.he = function (a) {
      this.V.style = a;return this;
    };var lh = function lh(a) {
      this.If = a;this.mc = null;this.ed = kh(this);
    },
        mh = function mh(a) {
      var b = new jh();b.V.where = document.body;b.V.url = a.If;b.V.messageHandlersFilter = M("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER");b.V.attributes = b.V.attributes || {};new ih(b.V.attributes).he({ position: "absolute", top: "-100px", width: "1px", height: "1px" });b.V.dontclear = !0;return b;
    },
        kh = function kh(a) {
      return nh().then(function () {
        return new A(function (b, c) {
          M("gapi.iframes.getContext")().open(mh(a).value(), function (d) {
            a.mc = d;a.mc.restyle({ setHideOnLeave: !1 });
      ...
      var b = this;return this.ed.then(function () {
        return new A(function (c) {
          b.mc.send(a.type, a, c, M("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"));
        });
      });
    };
    var ph = function ph(a, b) {
      a.ed.then(function () {
        a.mc.register("authEvent", b, M("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"));
      });
    },
        qh = new xf(3E4, 6E4),
        oh = new xf(5E3, 15E3),
      ...
      this.v = a;this.j = b;this.D = c;this.Xa = null;this.$b = Qe(this.v, "/__/auth/iframe");J(this.$b, "apiKey", this.j);J(this.$b, "appName", this.D);
    };rh.prototype.setVersion = function (a) {
      this.Xa = a;return this;
    };rh.prototype.toString = function () {
      this.Xa ? J(this.$b, "v", this.Xa) : this.$b.removeParameter("v");return this.$b.toString();
    };var sh = function sh(a, b, c, d, e) {
      this.v = a;this.j = b;this.D = c;this.ze = d;this.Xa = this.J = this.nd = null;this.Ob = e;
    };sh.prototype.setVersion = function (a) {
      this.Xa = a;return this;
    };
    sh.prototype.toString = function () {
      var a = Qe(this.v, "/__/auth/handler");J(a, "apiKey", this.j);J(a, "appName", this.D);J(a, "authType", this.ze);if (this.Ob.isOAuthProvider) {
        J(a, "providerId", this.Ob.providerId);var b = this.Ob,
            c = sf(b.Gd),
            d;for (d in c) {
          c[d] = c[d].toString();
        }b = b.sf;c = Xa(c);for (d = 0; d < b.length; d++) {
          var e = b[d];e in c && delete c[e];
        }Va(c) || J(a, "customParameters", rf(c));
      }"function" === typeof this.Ob.Pd && (b = this.Ob.Pd(), b.length && J(a, "scopes", b.join(",")));this.nd ? J(a, "redirectUrl", this.nd) : a.removeParameter("redirectUrl");
      this.J ? J(a, "eventId", this.J) : a.removeParameter("eventId");this.Xa ? J(a, "v", this.Xa) : a.removeParameter("v");if (this.ac) for (var f in this.ac) {
        this.ac.hasOwnProperty(f) && !Oe(a, f) && J(a, f, this.ac[f]);
      }return a.toString();
    };
    var th = function th(a, b, c, d) {
      this.v = a;this.j = b;this.D = c;this.Me = (this.Ea = d || null) ? mf(this.Ea) : null;d = this.Ea;this.Ve = new rh(a, b, c).setVersion(d).toString();this.ma = [];this.g = new S(b, null, this.Me);this.oc = this.va = null;
    },
        uh = function uh(a) {
    ...
    };h = th.prototype;h.Fb = function () {
      if (this.oc) return this.oc;var a = this;return this.oc = ff().then(function () {
        a.lc = new lh(a.Ve);vh(a);
      });
    };h.Ub = function (a, b, c) {
      var d = new O("popup-closed-by-user"),
          e = new O("web-storage-unsupported"),
          f = this,
          g = !1;return this.Ka().then(function () {
    ...
    h.ie = function () {
      ...
      return !1;
    };h.Mb = function (a, b, c, d, e, f, g) {
      if (!a) return D(new O("popup-blocked"));if (g && !qf()) return this.Ka().f(function (b) {
        bf(a);e(b);
      }), d(), B();this.va || (this.va = uh(this.g));var k = this;return this.va.then(function () {
        var b = k.Ka().f(function (b) {
          bf(a);e(b);throw b;
        });d();return b;
      }).then(function () {
        sg(c);if (!g) {
        ...
        "auth/network-request-failed" == a.code && (k.va = null);throw a;
      });
    };
    h.Nb = function (a, b, c) {
      this.va || (this.va = uh(this.g));var d = this;return this.va.then(function () {
        sg(b);var e = xh(d.v, d.j, d.D, a, b, We(), c, d.Ea);Xe(e);
      });
    };h.Ka = function () {
      var a = this;return this.Fb().then(function () {
        return a.lc.ed;
      }).f(function () {
        a.va = null;throw new O("network-request-failed");
      });
    };h.le = function () {
      return !0;
    };
    var xh = function xh(a, b, c, d, e, f, g, k, n) {
      a = new sh(a, b, c, d, e);a.nd = f;a.J = g;f = a.setVersion(k);f.ac = Xa(n || null);return f.toString();
    },
        vh = function vh(a) {
      if (!a.lc) throw Error("IfcHandler must be initialized!");ph(a.lc, function (b) {
        ...
        wh = function wh(a) {
      var b = { type: "webStorageSupport" };return a.Fb().then(function () {
        return a.lc.sendMessage(b);
      }).then(function (a) {
        if (a && a.length && "undefined" !== typeof a[0].webStorageSupport) return a[0].webStorageSupport;throw Error();
      });
    };th.prototype.Za = function (a) {
      this.ma.push(a);
    };th.prototype.Sb = function (a) {
    ...
    };h.$a = function () {};h.Sa = function () {};var Ah = function Ah() {
      this.B = {};
    ...
    };h.$a = function () {};h.Sa = function () {};var Ch = function Ch() {
      if (!Bh()) {
    ...
    h.get = function (a) {
      ...
      return B();
    };h.$a = function () {};h.Sa = function () {};var Fh = function Fh() {
      if (!Eh()) {
    ...
    };h.$a = function () {};h.Sa = function () {};var Gh = function Gh(a, b, c, d, e, f) {
      if (!window.indexedDB) throw new O("web-storage-unsupported");this.Fe = a;this.dd = b;this.Oc = c;this.pe = d;this.vb = e;this.$ = {};this.Vb = [];this.Ib = 0;this.We = f || l.indexedDB;
    },
        Hh,
        Ih = function Ih(a) {
      return new A(function (b, c) {
        var d = a.We.open(a.Fe, a.vb);d.onerror = function (a) {
          c(Error(a.target.errorCode));
        };d.onupgradeneeded = function (b) {
          b = b.target.result;try {
            b.createObjectStore(a.dd, { keyPath: a.Oc });
          } catch (f) {
            c(f);
          }
        ...
        Jh = function Jh(a) {
      a.Vd || (a.Vd = Ih(a));return a.Vd;
    },
        Kh = function Kh(a, b) {
      return b.objectStore(a.dd);
    },
        Lh = function Lh(a, b, c) {
      return b.transaction([a.dd], c ? "readwrite" : "readonly");
    },
        Mh = function Mh(a) {
      return new A(function (b, c) {
    ...
    h.set = function (a, b) {
      var c = !1,
        ...
        var g = Kh(e, Lh(e, d, !0));if (f) return f.value = b, Mh(g.put(f));e.Ib++;c = !0;f = {};f[e.Oc] = a;f[e.pe] = b;return Mh(g.add(f));
      }).then(function () {
        e.$[a] = b;
      }), function () {
        c && e.Ib--;
    ...
    h.remove = function (a) {
      var b = !1,
        ...
        b = !0;c.Ib++;return Mh(Kh(c, Lh(c, d, !0))["delete"](a));
      }).then(function () {
        delete c.$[a];
      }), function () {
        b && c.Ib--;
    ...
    h.Ef = function () {
      ...
      0 == this.Vb.length && this.td();this.Vb.push(a);
    };
    h.Sa = function (a) {
      La(this.Vb, function (b) {
        return b == a;
      });0 == this.Vb.length && this.Ac();
    };h.td = function () {
      var a = this;this.Ac();var b = function b() {
        a.hd = le(800).then(_q(a.Ef, a)).then(function (b) {
          0 < b.length && w(a.Vb, function (a) {
            a(b);
          });
        }).then(b).f(function (a) {
      ...
      this.Jd = { Browser: Nh, Node: Oh, ReactNative: Ph }[L()];
    },
        Rh,
        Nh = { M: Ch, wd: Fh },
        Oh = { M: Ch, wd: Fh },
        Ph = { M: zh, wd: Dh };var Sh = function Sh(a) {
      var b = {},
          c = a.email,
      ...
      this.lf = a;this.uf = b;this.Oe = c;this.qc = d;this.xd = e;this.vf = !!f;this.kb = null;this.La = this.qc;if (this.xd < this.qc) throw Error("Proactive refresh lower bound greater than upper bound!");
    };Th.prototype.start = function () {
      this.La = this.qc;Uh(this, !0);
    };
    var Vh = function Vh(a, b) {
      if (b) return a.La = a.qc, a.Oe();b = a.La;a.La *= 2;a.La > a.xd && (a.La = a.xd);return b;
    },
        Uh = function Uh(a, b) {
    ...
    var Yh = function Yh(a) {
      ...
      this.gf = a;this.fe = b;this.wf = c;this.Tb = d;this.T = {};Rh || (Rh = new Qh());a = Rh;try {
        var e;Ve() ? (Hh || (Hh = new Gh("firebaseLocalStorageDb", "firebaseLocalStorage", "fbase_key", "value", 1)), e = Hh) : e = new a.Jd.M();this.Pa = e;
      } catch (f) {
        this.Pa = new Ah(), this.Tb = !0;
      }try {
        this.Cc = new a.Jd.wd();
      } catch (f) {
        this.Cc = new Ah();
      }this.ud = _q(this.je, this);this.$ = {};
    },
        ci,
        di = function di() {
    ...
    h.R = function (a, b) {
      return this.gf + this.fe + a.name + (b ? this.fe + b : "");
    };h.get = function (a, b) {
      return (a.M ? this.Pa : this.Cc).get(this.R(a, b));
    };h.remove = function (a, b) {
      b = this.R(a, b);a.M && !this.Tb && (this.$[b] = null);return (a.M ? this.Pa : this.Cc).remove(b);
    };h.set = function (a, b, c) {
      var d = this.R(a, c),
          e = this,
          f = a.M ? this.Pa : this.Cc;return f.set(d, b).then(function () {
        return f.get(d);
      }).then(function (b) {
        a.M && !this.Tb && (e.$[d] = b);
      });
    ...
    h.addListener = function (a, b, c) {
      a = this.R(a, b);this.Tb || (this.$[a] = l.localStorage.getItem(a));Va(this.T) && this.td();this.T[a] || (this.T[a] = []);this.T[a].push(c);
    };h.removeListener = function (a, b, c) {
      a = this.R(a, b);this.T[a] && (La(this.T[a], function (a) {
        return a == c;
      }), 0 == this.T[a].length && delete this.T[a]);Va(this.T) && this.Ac();
    };h.td = function () {
      this.Pa.$a(this.ud);this.Tb || Ve() || ei(this);
    };
    var ei = function ei(a) {
      fi(a);a.bd = setInterval(function () {
        for (var b in a.T) {
          var c = l.localStorage.getItem(b),
              d = a.$[b];c != d && (a.$[b] = c, c = new Jb({ type: "storage", key: b, target: window, oldValue: d, newValue: c, nf: !0 }), a.je(c));
        }
      }, 1E3);
    },
        fi = function fi(a) {
      ...
      this.Pa.Sa(this.ud);fi(this);
    };
    bi.prototype.je = function (a) {
      if (a && a.Ne) {
        var b = a.eb.key;"undefined" !== typeof a.eb.nf ? this.Pa.Sa(this.ud) : fi(this);if (this.wf) {
          var c = l.localStorage.getItem(b);a = a.eb.newValue;a != c && (a ? l.localStorage.setItem(b, a) : a || l.localStorage.removeItem(b));
        }this.$[b] = l.localStorage.getItem(b);this.Cd(b);
      } else w(a, _q(this.Cd, this));
    ...
    };gi.prototype.Za = function (a) {
      this.i.addListener(hi, this.u, a);
    };gi.prototype.Sb = function (a) {
      this.i.removeListener(hi, this.u, a);
    };var ji = function ji(a) {
      this.i = a || di();
    },
        ki = { name: "sessionId", M: !1 };ji.prototype.hc = function (a) {
      return this.i.get(ki, a);
    };var li = function li(a, b, c, d, e, f) {
      this.v = a;this.j = b;this.D = c;this.Ea = d || null;this.ke = b + ":" + c;this.xf = new ji();this.Od = new gi(this.ke);this.Xc = null;this.ma = [];this.Ze = e || 500;this.qf = f || 2E3;this.Eb = this.tc = null;
    },
        mi = function mi(a) {
      return new O("invalid-cordova-configuration", a);
    };
    li.prototype.Ka = function () {
      return this.Zc ? this.Zc : this.Zc = hf().then(function () {
    ...
    };h = li.prototype;h.Ub = function (a, b) {
    ...
    h.Nb = function (a, b, c) {
      if (this.tc) return D(new O("redirect-operation-pending"));var d = this,
          e = l.document,
          f = null,
          g = null,
          k = null,
          n = null;return this.tc = md(B().then(function () {
        sg(b);return pi(d);
      }).then(function () {
        return qi(d, a, b, c);
      }).then(function () {
        return new A(function (a, b) {
          g = function g() {
            var b = M("cordova.plugins.browsertab.close", l);a();"function" === typeof b && b();d.Eb && "function" === typeof d.Eb.close && (d.Eb.close(), d.Eb = null);return !1;
          };d.Za(g);k = function k() {
            f || (f = le(d.qf).then(function () {
        ...
        k && e.removeEventListener("resume", k, !1);n && e.removeEventListener("visibilitychange", n, !1);f && f.cancel();g && d.Sb(g);d.tc = null;
      });
    };
    var qi = function qi(a, b, c, d) {
      var e = ni(),
          ...
          n = {};if (K().toLowerCase().match(/iphone|ipad|ipod/)) n.ibi = g;else if (K().toLowerCase().match(/android/)) n.apn = g;else return D(new O("operation-not-supported-in-this-environment"));k && (n.appDisplayName = k);e = oi(e);n.sessionId = e;var C = xh(a.v, a.j, a.D, b, c, null, d, a.Ea, n);return a.Ka().then(function () {
        var b = a.ke;return a.xf.i.set(hi, f.C(), b);
      }).then(function () {
        var b = M("cordova.plugins.browsertab.isAvailable", l);if ("function" !== typeof b) throw new O("invalid-cordova-configuration");var c = null;b(function (b) {
          if (b) {
            ...
            a.Eb = b(C, d ? "_blank" : "_system", "location=yes");
          }
        });
      });
    },
      ...
      a.Xc || (a.Xc = a.Ka().then(function () {
        ...
        ri = function ri(a) {
      var b = null;return ii(a.Od).then(function (c) {
        b = c;c = a.Od;return c.i.remove(hi, c.u);
      }).then(function () {
        return b;
      });
    },
        ...
        d = !0;e && e.cancel();ri(a).then(function (d) {
          var e = c;if (d && b && b.url) {
            var e = null,
                ...
                k = Oe(g, "link"),
                n = Oe(Pe(k), "link"),
                g = Oe(g, "deep_link_id");f = Oe(Pe(g), "link") || g || n || k || f;-1 != f.indexOf("/__/auth/callback") && (e = Pe(f), e = tf(Oe(e, "firebaseError") || null), e = (e = "object" === typeof e ? Pf(e) : null) ? new P(d.da, d.J, null, null, e) : new P(d.da, d.J, f, d.hc()));
            e = e || c;
          }si(a, e);
        });
      },
      ...
      this.ma.push(a);pi(this).f(function () {});
    };li.prototype.Sb = function (a) {
      La(this.ma, function (b) {
        return b == a;
      });
      ...
      this.v = a;this.j = b;this.D = c;this.Wb = [];this.ib = !1;this.Kc = _q(this.Uc, this);this.Qa = new zi(this);this.jd = new Ai(this);this.Jb = new ui(this.j + ":" + this.D);this.Aa = {};this.Aa.unknown = this.Qa;this.Aa.signInViaRedirect = this.Qa;this.Aa.linkViaRedirect = this.Qa;this.Aa.reauthViaRedirect = this.Qa;this.Aa.signInViaPopup = this.jd;this.Aa.linkViaPopup = this.jd;this.Aa.reauthViaPopup = this.jd;this.K = Bi(this.v, this.j, this.D);
    },
        Bi = function Bi(a, b, c) {
      var d = firebase.SDK_VERSION || null;return gf() ? new li(a, b, c, d) : new th(a, b, c, d);
    };T.prototype.reset = function () {
      this.ib = !1;this.K.Sb(this.Kc);this.K = Bi(this.v, this.j, this.D);
    };T.prototype.Fb = function () {
      var a = this;this.ib || (this.ib = !0, this.K.Za(this.Kc));var b = this.K;return this.K.Ka().f(function (c) {
        a.K == b && a.reset();throw c;
      });
    };var Ei = function Ei(a) {
      a.K.ie() && a.Fb().f(function (b) {
        var c = new P("unknown", null, null, null, new O("operation-not-supported-in-this-environment"));Ci(b) && a.Uc(c);
      });a.K.Sd() || Di(a.Qa);
    };
    T.prototype.subscribe = function (a) {
      Ia(this.Wb, a) || this.Wb.push(a);if (!this.ib) {
        var b = this;yi(this.Jb).then(function (a) {
          a ? xi(b.Jb).then(function () {
            b.Fb().f(function (a) {
              var c = new P("unknown", null, null, null, new O("operation-not-supported-in-this-environment"));Ci(a) && b.Uc(c);
            });
          }) : Ei(b);
        }).f(function () {
          Ei(b);
    ...
    T.prototype.Uc = function (a) {
      if (!a) throw new O("invalid-auth-event");for (var b = !1, c = 0; c < this.Wb.length; c++) {
        var d = this.Wb[c];if (d.Dd(a.da, a.J)) {
          (b = this.Aa[a.da]) && b.ae(a, d);b = !0;break;
        }
      }Di(this.Qa);return b;
    };var Fi = new xf(2E3, 1E4),
        Gi = new xf(3E4, 6E4);T.prototype.getRedirectResult = function () {
      return this.Qa.getRedirectResult();
    };T.prototype.Mb = function (a, b, c, d, e) {
      var f = this;return this.K.Mb(a, b, c, function () {
        f.ib || (f.ib = !0, f.K.Za(f.Kc));
      }, function () {
        f.reset();
      }, d, e);
    };
    var Ci = function Ci(a) {
      ...
      var d = this,
          e;return wi(this.Jb).then(function () {
        return d.K.Nb(a, b, c).f(function (a) {
          if (Ci(a)) throw new O("operation-not-supported-in-this-environment");e = a;return xi(d.Jb).then(function () {
            throw e;
          });
        }).then(function () {
          return d.K.le() ? new A(function () {}) : xi(d.Jb).then(function () {
    ...
    T.prototype.Ub = function (a, b, c, d) {
      ...
      var d = b + ":" + c;Hi[d] || (Hi[d] = new T(a, b, c));return Hi[d];
        ...
        zi = function zi(a) {
      this.i = a;this.qb = null;this.Qb = [];this.Pb = [];this.ob = null;this.md = !1;
    };zi.prototype.reset = function () {
      this.qb = null;this.ob && (this.ob.cancel(), this.ob = null);
    };
    zi.prototype.ae = function (a, b) {
      if (!a) return D(new O("invalid-auth-event"));this.reset();this.md = !0;var c = a.da,
          d = a.J,
          e = a.getError() && "auth/web-storage-unsupported" == a.getError().code,
          f = a.getError() && "auth/operation-not-supported-in-this-environment" == a.getError().code;"unknown" != c || e || f ? a = a.P ? this.kd(a, b) : b.yb(c, d) ? this.ld(a, b) : D(new O("invalid-auth-event")) : (Ji(this, !1, null, null), a = B());return a;
    };var Di = function Di(a) {
      a.md || (a.md = !0, Ji(a, !1, null, null));
    };
    zi.prototype.kd = function (a) {
      Ji(this, !0, null, a.getError());return B();
    };zi.prototype.ld = function (a, b) {
      var c = this;b = b.yb(a.da, a.J);var d = a.tb,
          e = a.hc(),
    ...
    var Ki = function Ki(a, b) {
      a.qb = function () {
        return D(b);
      };if (a.Pb.length) for (var c = 0; c < a.Pb.length; c++) {
        a.Pb[c](b);
      }
    },
        Li = function Li(a, b) {
      ...
      b ? d ? Ki(a, d) : Li(a, c) : Li(a, { user: null });a.Qb = [];a.Pb = [];
    };zi.prototype.getRedirectResult = function () {
      var a = this;return new A(function (b, c) {
        a.qb ? a.qb().then(b, c) : (a.Qb.push(b), a.Pb.push(c), Mi(a));
      });
    };
    var Mi = function Mi(a) {
      var b = new O("timeout");a.ob && a.ob.cancel();a.ob = le(Gi.get()).then(function () {
        ...
        Ai = function Ai(a) {
      this.i = a;
    };Ai.prototype.ae = function (a, b) {
      if (!a) return D(new O("invalid-auth-event"));var c = a.da,
          d = a.J;return a.P ? this.kd(a, b) : b.yb(c, d) ? this.ld(a, b) : D(new O("invalid-auth-event"));
    };Ai.prototype.kd = function (a, b) {
      b.Ua(a.da, null, a.getError(), a.J);return B();
    };
    Ai.prototype.ld = function (a, b) {
      var c = a.J,
          d = a.da,
          e = b.yb(d, c),
          f = a.tb;a = a.hc();return e(f, a).then(function (a) {
        b.Ua(d, a, null, c);
      }).f(function (a) {
        b.Ua(d, null, a, c);
      });
    };var Ni = function Ni(a) {
      this.g = a;this.Ba = this.X = null;this.Ga = 0;
    };Ni.prototype.C = function () {
      return { apiKey: this.g.j, refreshToken: this.X, accessToken: this.Ba, expirationTime: this.Ga };
    };
    var Pi = function Pi(a, b) {
      var c = b.idToken,
          d = b.refreshToken;b = Oi(b.expiresIn);a.Ba = c;a.Ga = b;a.X = d;
    },
        Oi = function Oi(a) {
      ...
      return Eg(a.g, b).then(function (b) {
        a.Ba = b.access_token;a.Ga = Oi(b.expires_in);a.X = b.refresh_token;return { accessToken: a.Ba, expirationTime: a.Ga, refreshToken: a.X };
      }).f(function (b) {
        "auth/user-token-expired" == b.code && (a.X = null);throw b;
      });
    };
    Ni.prototype.getToken = function (a) {
      a = !!a;return this.Ba && !this.X ? D(new O("user-token-expired")) : a || !this.Ba || la() > this.Ga - 3E4 ? this.X ? Qi(this, { grant_type: "refresh_token", refresh_token: this.X }) : B(null) : B({ accessToken: this.Ba, expirationTime: this.Ga, refreshToken: this.X });
    ...
    var U = function U(a, b, c) {
      this.ba = [];this.j = a.apiKey;this.D = a.appName;this.v = a.authDomain || null;a = firebase.SDK_VERSION ? mf(firebase.SDK_VERSION) : null;this.g = new S(this.j, null, a);this.ia = new Ni(this.g);Ti(this, b.idToken);Pi(this.ia, b);N(this, "refreshToken", this.ia.X);Ui(this, c || {});he.call(this);this.uc = !1;this.v && pf() && (this.m = Ii(this.v, this.j, this.D));this.zc = [];this.ka = null;this.mb = Vi(this);this.ub = _q(this.Vc, this);
    };r(U, he);U.prototype.Vc = function () {
    ...
    var Vi = function Vi(a) {
      return new Th(function () {
        ...
        var b = a.ia.Ga - la() - 3E5;return 0 < b ? b : 0;
      }, 3E4, 96E4, !1);
    },
        Wi = function Wi(a) {
      a.Id || a.mb.kb || (a.mb.start(), dc(a, "tokenChanged", a.ub), Vb(a, "tokenChanged", a.ub));
    },
        Xi = function Xi(a) {
      dc(a, "tokenChanged", a.ub);a.mb.stop();
    },
        Ti = function Ti(a, b) {
      a.Wd = b;N(a, "_lat", b);
    },
      ...
      for (var b = [], c = 0; c < a.zc.length; c++) {
        ...
        $i = function $i(a) {
      a.m && !a.uc && (a.uc = !0, a.m.subscribe(a));
    },
        Ui = function Ui(a, b) {
    ...
    var aj = function aj() {},
      ...
      return B().then(function () {
        if (a.Id) throw new O("app-deleted");
      });
    },
        cj = function cj(a) {
    ...
    var gj = function gj(a) {
      ...
      var b = this;return this.c(bj(this).then(function () {
        ...
        if (!a) throw new O("internal-error");a.accessToken != b.Wd && (Ti(b, a.accessToken), b.Ma());fj(b, "refreshToken", a.refreshToken);return a.accessToken;
      }));
    };
    var ij = function ij(a, b) {
      b.idToken && a.Wd != b.idToken && (Pi(a.ia, b), a.Ma(), Ti(a, b.idToken), fj(a, "refreshToken", a.ia.X));
    };U.prototype.Ma = function () {
      this.dispatchEvent(new Si("tokenChanged"));
    };var hj = function hj(a, b) {
      return R(a.g, gh, { idToken: b }).then(_q(a.mf, a));
    };
    ...
    var jj = function jj(a) {
      return (a = a.providerUserInfo) && a.length ? Ea(a, function (a) {
        ...
        lj = function lj(a, b) {
      var c = null;return a.c(b.cd(a.g, a.uid).then(function (b) {
    ...
    h["delete"] = function () {
      var a = this;return this.c(this.getToken().then(function (b) {
        ...
        }a.ba = [];a.Id = !0;Xi(a);N(a, "refreshToken", null);a.m && a.m.unsubscribe(a);
      });
    };
    h.Dd = function (a, b) {
      return "linkViaPopup" == a && (this.ca || null) == b && this.aa || "reauthViaPopup" == a && (this.ca || null) == b && this.aa || "linkViaRedirect" == a && (this.ya || null) == b || "reauthViaRedirect" == a && (this.ya || null) == b ? !0 : !1;
    };h.Ua = function (a, b, c, d) {
      "linkViaPopup" != a && "reauthViaPopup" != a || d != (this.ca || null) || (c && this.Oa ? this.Oa(c) : b && !c && this.aa && this.aa(b), this.F && (this.F.cancel(), this.F = null), delete this.aa, delete this.Oa);
    };
    h.yb = function (a, b) {
      return "linkViaPopup" == a && b == (this.ca || null) ? _q(this.Ld, this) : "reauthViaPopup" == a && b == (this.ca || null) ? _q(this.Md, this) : "linkViaRedirect" == a && (this.ya || null) == b ? _q(this.Ld, this) : "reauthViaRedirect" == a && (this.ya || null) == b ? _q(this.Md, this) : null;
    };h.gc = function () {
      return of(this.uid + ":::");
    ...
    var pj = function pj(a, b, c, d, e) {
      if (!pf()) return D(new O("operation-not-supported-in-this-environment"));if (a.ka && !e) return D(a.ka);var f = Nf(c.providerId),
          g = a.gc(),
          k = null;(!qf() || kf()) && a.v && c.isOAuthProvider && (k = xh(a.v, a.j, a.D, b, c, null, g, firebase.SDK_VERSION || null));var n = cf(k, f && f.Lb, f && f.Kb);d = d().then(function () {
        sj(a);if (!e) return a.getToken().then(function () {});
      }).then(function () {
        return a.m.Mb(n, b, c, g, !!k);
      }).then(function () {
        return new A(function (c, d) {
          a.Ua(b, null, new O("cancelled-popup-request"), a.ca || null);a.aa = c;a.Oa = d;a.ca = g;a.F = a.m.Ub(a, b, n, g);
        });
      }).then(function (a) {
        n && bf(n);return a;
      }).f(function (a) {
    ...
    var tj = function tj(a, b, c, d, e) {
      if (!pf()) return D(new O("operation-not-supported-in-this-environment"));if (a.ka && !e) return D(a.ka);var f = null,
          g = a.gc();d = d().then(function () {
        sj(a);if (!e) return a.getToken().then(function () {});
      }).then(function () {
        a.ya = g;return Zi(a);
      }).then(function (b) {
        a.Ra && (b = a.Ra, b = b.i.set(uj, a.C(), b.u));return b;
      }).then(function () {
        return a.m.Nb(b, c, g);
      }).f(function (b) {
        f = b;if (a.Ra) return vj(a.Ra);throw f;
      }).then(function () {
        if (f) throw f;
      });return a.c(d, e);
    },
        sj = function sj(a) {
      if (!a.m || !a.uc) {
        if (a.m && !a.uc) throw new O("internal-error");throw new O("auth-domain-config-required");
      }
    ...
    var xj = function xj(a) {
      if (!a.apiKey) return null;var b = { apiKey: a.apiKey, authDomain: a.authDomain, appName: a.appName },
        ...
        a && ej(d, Gf(a));
      });a.redirectEventId && (d.ya = a.redirectEventId);return d;
    },
        yj = function yj(a, b, c) {
      var d = new U(a, b);c && (d.Ra = c);return d.reload().then(function () {
        return d;
      });
      ...
      this.bb = !1;N(this, "app", a);if (V(this).options && V(this).options.apiKey) a = firebase.SDK_VERSION ? mf(firebase.SDK_VERSION) : null, this.g = new S(V(this).options && V(this).options.apiKey, null, a);else throw new O("invalid-api-key");this.ba = [];this.Ca = [];this.jf = firebase.INTERNAL.createSubscribe(_q(this.Xe, this));Gj(this, null);this.sa = new Bj(V(this).options.apiKey + ":" + V(this).name);this.pb = new zj(V(this).options.apiKey + ":" + V(this).name);this.bc = this.c(Hj(this));this.za = this.c(Ij(this));this.$c = !1;this.Tc = _q(this.Df, this);this.oe = _q(this.gb, this);this.ub = _q(this.Vc, this);this.me = _q(this.Se, this);this.ne = _q(this.Te, this);Jj(this);this.INTERNAL = {};this.INTERNAL["delete"] = _q(this["delete"], this);this.Ha = 0;
    ...
    var Kj = function Kj(a) {
      return a.Ge || D(new O("auth-domain-config-required"));
    },
        Jj = function Jj(a) {
      var b = V(a).options.authDomain,
          c = V(a).options.apiKey;b && pf() && (a.Ge = a.bc.then(function () {
        if (!a.bb) return a.m = Ii(b, c, V(a).name), a.m.subscribe(a), X(a) && $i(X(a)), a.Rb && ($i(a.Rb), a.Rb = null), a.m;
      }));
    };h = W.prototype;h.Dd = function (a, b) {
    ...
    h.Ua = function (a, b, c, d) {
      "signInViaPopup" == a && this.ca == d && (c && this.Oa ? this.Oa(c) : b && !c && this.aa && this.aa(b), this.F && (this.F.cancel(), this.F = null), delete this.aa, delete this.Oa);
    };h.yb = function (a, b) {
      return "signInViaRedirect" == a || "signInViaPopup" == a && this.ca == b && this.aa ? _q(this.Ie, this) : null;
    };
    h.Ie = function (a, b) {
    ...
    var Mj = function Mj(a, b) {
      if (!pf()) return D(new O("operation-not-supported-in-this-environment"));var c = Nf(b.providerId),
          d = a.gc(),
          e = null;(!qf() || kf()) && V(a).options.authDomain && b.isOAuthProvider && (e = xh(V(a).options.authDomain, V(a).options.apiKey, V(a).name, "signInViaPopup", b, null, d, firebase.SDK_VERSION || null));var f = cf(e, c && c.Lb, c && c.Kb),
          c = Kj(a).then(function (a) {
        return a.Mb(f, "signInViaPopup", b, d, !!e);
      }).then(function () {
        return new A(function (b, c) {
          a.Ua("signInViaPopup", null, new O("cancelled-popup-request"), a.ca);a.aa = b;a.Oa = c;a.ca = d;a.F = a.m.Ub(a, "signInViaPopup", f, d);
        });
      }).then(function (a) {
        f && bf(f);return a;
      }).f(function (a) {
    ...
    W.prototype.signInWithRedirect = function (a) {
      if (!pf()) return D(new O("operation-not-supported-in-this-environment"));var b = this,
        ...
        return b.m.Nb("signInViaRedirect", a);
      });return this.c(c);
    };
    var Nj = function Nj(a) {
      if (!pf()) return D(new O("operation-not-supported-in-this-environment"));var b = Kj(a).then(function () {
        ...
        Lj = function Lj(a, b) {
      var c = {};c.apiKey = V(a).options.apiKey;c.authDomain = V(a).options.authDomain;c.appName = V(a).name;return a.bc.then(function () {
        return yj(c, b, a.pb);
      }).then(function (b) {
        ...
        Gj = function Gj(a, b) {
      X(a) && (Yi(X(a), a.oe), dc(X(a), "tokenChanged", a.ub), dc(X(a), "userDeleted", a.me), dc(X(a), "userInvalidated", a.ne), Xi(X(a)));b && (b.zc.push(a.oe), Vb(b, "tokenChanged", a.ub), Vb(b, "userDeleted", a.me), Vb(b, "userInvalidated", a.ne), 0 < a.Ha && Wi(b));N(a, "currentUser", b);
    };W.prototype.signOut = function () {
      var a = this,
          b = this.za.then(function () {
        if (!X(a)) return B();Gj(a, null);return Ej(a.sa).then(function () {
          a.Ma();
        });
      });return this.c(b);
    };
    var Oj = function Oj(a) {
      var b = Aj(a.pb, V(a).options.authDomain).then(function (b) {
        if (a.Rb = b) b.Ra = a.pb;return vj(a.pb);
      });return a.c(b);
    },
        Hj = function Hj(a) {
      var b = V(a).options.authDomain,
        ...
        return b ? (b.Ra = a.pb, a.Rb && (a.Rb.ya || null) == (b.ya || null) ? b : b.reload().then(function () {
          return Dj(a.sa, b).then(function () {
            return b;
          });
        }).f(function (c) {
          return "auth/network-request-failed" == c.code ? b : Ej(a.sa);
        })) : null;
      }).then(function (b) {
        Gj(a, b || null);
      });return a.c(c);
        ...
        Ij = function Ij(a) {
      return a.bc.then(function () {
        return a.getRedirectResult();
      }).f(function () {}).then(function () {
        if (!a.bb) return a.Tc();
      }).f(function () {}).then(function () {
        if (!a.bb) {
          a.$c = !0;var b = a.sa;b.i.addListener(Cj, b.u, a.Tc);
        }
      });
    };h = W.prototype;h.Df = function () {
      var a = this;return Fj(this.sa, V(this).options.authDomain).then(function (b) {
        if (!a.bb) {
          var c;if (c = X(a) && b) {
            c = X(a).uid;var d = b.uid;c = void 0 === c || null === c || "" === c || void 0 === d || null === d || "" === d ? !1 : c == d;
          }if (c) return X(a).copy(b), X(a).getToken();if (X(a) || b) Gj(a, b), b && ($i(b), b.Ra = a.pb), a.m && a.m.subscribe(a), a.Ma();
        }
      });
    };h.gb = function (a) {
      return Dj(this.sa, a);
    };h.Vc = function () {
      this.Ma();this.gb(X(this));
    };h.Se = function () {
      this.signOut();
    };
    h.Te = function () {
    ...
    h.getToken = function (a) {
      ...
      var c = this;return this.za.then(function () {
    ...
    h.createUserWithEmailAndPassword = function (a, b) {
      ...
      return a.za.then(function () {
        return Pj(a, b.zb(a.g));
      });
    };
    W.prototype.signInAnonymously = function () {
      var a = X(this),
          b = this;return a && a.isAnonymous ? B(a) : this.za.then(function () {
    ...
    };h = W.prototype;h.getUid = function () {
      return X(this) && X(this).uid || null;
    };h.Ma = function () {
      if (this.$c) for (var a = 0; a < this.Ca.length; a++) {
        if (this.Ca[a]) this.Ca[a](X(this) && X(this)._lat || null);
      }
    };
    h.ye = function (a) {
      this.addAuthTokenListener(a);this.Ha++;0 < this.Ha && X(this) && Wi(X(this));
    };h.rf = function (a) {
      var b = this;w(this.Ca, function (c) {
        c == a && b.Ha--;
      });0 > this.Ha && (this.Ha = 0);0 == this.Ha && X(this) && Xi(X(this));this.removeAuthTokenListener(a);
    };h.addAuthTokenListener = function (a) {
      var b = this;this.Ca.push(a);this.c(this.za.then(function () {
        b.bb || Ia(b.Ca, a) && a(X(b) && X(b)._lat || null);
      }));
    ...
    h["delete"] = function () {
      this.bb = !0;for (var a = 0; a < this.ba.length; a++) {
        this.ba[a].cancel("app-deleted");
      }this.ba = [];this.sa && (a = this.sa, a.i.removeListener(Cj, a.u, this.Tc));this.m && this.m.unsubscribe(this);return firebase.Promise.resolve();
    };h.c = function (a) {
    ...
    h.confirmPasswordReset = function (a, b) {
    ...
    };var Rj = "First Second Third Fourth Fifth Sixth Seventh Eighth Ninth".split(" "),
        Y = function Y(a, b) {
      ...
      for (var c in b) {
        var d = b[c].name;a[d] = Xj(d, a[c], b[c].a);
      }
    },
        Zj = function Zj(a, b, c, d) {
      a[b] = Xj(b, c, d);
    },
        Xj = function Xj(a, b, c) {
      if (!c) return b;var d = ak(a);a = function a() {
          ...
          e = Array.prototype.slice.call(a);var k;k = 0;for (var n = !1, C = 0; C < c.length; C++) {
            ...
            for (k = 0; k < e.length; k++) {
              if (n = c[k].optional && void 0 === e[k], !c[k].la(e[k]) && !n) {
                e = c[k];if (0 > k || k >= Rj.length) throw new O("internal-error", "Argument validator received an unsupported number of arguments.");e = Rj[k] + " argument " + (e.name ? '"' + e.name + '" ' : "") + "must be " + e.ja + ".";break a;
              }
            }e = null;
          }
    ...
    (function () {
      if ("undefined" !== typeof firebase && firebase.INTERNAL && firebase.INTERNAL.registerService) {
        var a = { Auth: W, Error: O };Zj(a, "EmailAuthProvider", kg, []);Zj(a, "FacebookAuthProvider", $f, []);Zj(a, "GithubAuthProvider", bg, []);Zj(a, "GoogleAuthProvider", dg, []);Zj(a, "TwitterAuthProvider", fg, []);firebase.INTERNAL.registerService("auth", function (a, c) {
          a = new W(a);c({ INTERNAL: { getUid: _q(a.getUid, a), getToken: _q(a.getToken, a), addAuthTokenListener: _q(a.ye, a), removeAuthTokenListener: _q(a.rf, a) } });return a;
        }, a, function (a, c) {
          if ("create" === a) try {
            c.auth();
          } catch (d) {}
